...
murmurations::Flock::Flock(int n) {
  ...
  // boids.push_back(Boid(0, basic, Eigen::Vector2d(200, 300),
  // Eigen::Vector2d(0, 0))); boids.push_back(Boid(1, basic, Eigen::Vector2d(300,
  // 300), Eigen::Vector2d(0, 0))); boids.push_back(Boid(2, basic,
  // Eigen::Vector2d(400, 300), Eigen::Vector2d(0, 0))); boids.push_back(Boid(3,
  // basic, Eigen::Vector2d(300, 400), Eigen::Vector2d(0, 0)));
}
